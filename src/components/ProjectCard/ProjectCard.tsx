  ...
  return (
    <>
      <section className="w-full mb-12 mt-3" data-testid="ProjectCardContainer">
        <div className="w-full rounded-lg" data-testid="ProjectCardImageWrapper">
          <Image
            src={organi}
        ...
        <div className="pt-10 pb-3" data-testid="ProjectCardTitleContainer">
          <h2 className="font-semibold text-text_primary" data-testid="ProjectCardTitle">
            Organi | E-commerce Store
          </h2>
          <p className="py-3 text-sm text-gray-400 max-w-full truncate" data-testid="ProjectCardDescription">
            Organi is a one stop for all your groceries and fashion items
          </p>
        </div>
        <div className="py-2">
          <ul className="flex items-center gap-3 text-xs" data-testid="ProjectCardToolsWrapper">
            <li className="text-xs" data-testid="ProjectCardToolsList">Nextjs</li>
            <li>Nextjs</li>
            <li>Nextjs</li>
            <li>Nextjs</li>
          </ul>
        ...
        <div data-testid="ProjectCardFooter" className="flex flex-col gap-3 md:flex-row md:justify-between md:items-center pt-6 pb-6 md:pb-14">
